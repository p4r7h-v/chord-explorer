...
![Chord Explorer with piano selected, six E minor chord buttons, and recent chord history](docs/chord-explorer.jpg)
...
![F minor with Supersaw selected and an Fm, Db, Ab, Eb progression in the chord history](docs/supersaw-chords.jpg)
